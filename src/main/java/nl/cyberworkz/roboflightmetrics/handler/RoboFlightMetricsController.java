...
public class RoboFlightMetricsController {

	private static final Logger LOG = LoggerFactory.getLogger(RoboFlightMetricsController.class);

	@Autowired
	private RoboFlightMetricsService service;
